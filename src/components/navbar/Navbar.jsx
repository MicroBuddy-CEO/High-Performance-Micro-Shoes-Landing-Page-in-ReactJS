  ...
  return (
    <nav className="w-full px-[150px]">
      ...
      <div className="flex  justify-between items-center pt-[30px] pr-4">
        ...
        <a href="" className="flex items-center w-[165px] h-[90px]">

          <h1 className="text-[27px] font-[900] text-white uppercase">Micro</h1>

          <span className="ml-[-18px]">
            <img src={logo} alt="" width={59} height={59} className="ml-[18px]"/>
            <h1 className="text-[27px] font-[900] text-white uppercase">
              Shoe
            </h1>
          </span>
        </a>
        ...
        <div className="flex space-x-[80px]">
          ...
          <div className="w-[290px] h-[34px] rounded-[48px] border border-[#CF9C5D] flex justify-between px-2 items-center serachbar">
            <input type="text" className="w-[260px] h-[34px] rounded-[48px] bg-transparent focus:outline-none pl-2 text-white"/>
